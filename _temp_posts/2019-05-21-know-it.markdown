...
- strong은 비동기 클로저에 매개변수로 전달할때 적합합니다.
...
Operator는 observabled에서 발생되는 이벤트를 변환하고 처리 할 수 있다
...
> 구현해야 하는 동작을 지정하는데 사용되는 추상적 표현을 정의하고 기능 구현을 하자!! 입니다. Java의 Interface라 생각하시면 됩니다.
- 보안성
...
##generic
> 모든 타입에서 작동할 수 있는 유연하고, 재사용 가능한 함수와 타입을 작성할 수 있습니다.
